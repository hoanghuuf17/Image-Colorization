...
def load_data(i):
    with open('D:/PYTHON/Do_An_5/Do_An/data_processed/X_' + str(i) + '.pkl', 'rb') as f:
        images = pickle.load(f)

    with open('D:/PYTHON/Do_An_5/Do_An/data_processed/y_' + str(i) + '.pkl', 'rb') as f:
...
model_tmp.summary()
# activation_9 = 'activation_9'
# activation_21 = 'activation_21'
# activation_39 = 'activation_39'
# activation_49 = 'activation_48'
...
layer_3 = model_tmp.get_layer('activation_9').output
layer_7 = model_tmp.get_layer('activation_21').output
layer_13 = model_tmp.get_layer('activation_39').output
layer_16 = model_tmp.get_layer('activation_48').output
...
filepath = 'D:/PYTHON/Do_An_5/Do_An/models/model_12_1.h5'
