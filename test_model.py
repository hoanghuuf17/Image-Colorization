...
'''
json_file = open('D:/PYTHON/Do_An_5/Do_An/models/model_15_1.json', 'r')
...
model.load_weights("D:/PYTHON/Do_An_5/Do_An/models/model_12_1.h5")
print("Loaded model from disk")


import pickle

with open('D:/PYTHON/Do_An_5/Do_An/data_processed/X_10.pkl', 'rb') as f:
    X = pickle.load(f)
with open('D:/PYTHON/Do_An_5/Do_An/data_processed/y_10.pkl', 'rb') as f:
    y = pickle.load(f)
